...
3. **Manual cleanup**:
   ...
   taskkill /f /im python.exe /fi "WINDOWTITLE eq *feedback-one*"
...
**Cause**: Frequent use of `uvx feedback-one@latest`
...
2. Report issues on [GitHub Issues](https://github.com/Minidoracat/feedback-one/issues)
