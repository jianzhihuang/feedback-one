...
本文檔說明如何構建 Feedback One 的桌面應用程式。
...
│   ├── __init__.py
│   ├── feedback-one-desktop.exe              # Windows
│   ├── feedback-one-desktop-macos-intel     # macOS Intel
│   ├── feedback-one-desktop-macos-arm64     # macOS Apple Silicon
│   └── feedback-one-desktop-linux           # Linux
...
- **Windows**: `feedback-one-desktop.exe`
- **macOS Intel**: `feedback-one-desktop-macos-intel`
- **macOS Apple Silicon**: `feedback-one-desktop-macos-arm64`
- **Linux**: `feedback-one-desktop-linux`
...
- 二進制檔案: `feedback-one-desktop.exe`

### Linux/macOS
- 二進制檔案: `feedback-one-desktop`
- 自動設置執行權限
